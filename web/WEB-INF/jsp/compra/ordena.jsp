<%-- 
    Document   : ordena
    Created on : 30-oct-2017, 13:07:13
    Author     : Erggeretto
--%>
...
<html>
    ...
    <body ng-controller="IndiceControlador">
        ...
        <div ng-class="titulosCss.titulo"> Resumen Orden de Compra </div>
        <div ng-class="explicacionCss.explica"> Despliegue de compras y registro </div>
        <form action="compras/pago.htm" method="post">
            <table>
                <thead>
                <tr>
                    <th>Orden</th>
                ...
                <tr ng-repeat="ordenDetalle" ng-style="{color:($odd?'blue':'green')}">
                    ...
                    <td><input id="idProducto{{ordenDetalle.idProducto}}" name="idProducto{{ordenDetalle.idProducto}}" 
                               type="hidden" ng-model="compra/pago{{ordenDetalle.idProducto}}">
                    </td>
                </tr>
                </tbody>
            </table>
